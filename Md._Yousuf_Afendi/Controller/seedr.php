...
if ($result->num_rows > 0) {
  ...
  echo '<h1 style="border-bottom: 3px skyblue solid; display: block; margin: 0 auto; width: 270px;">Doctor Database</h1>';
  ...
  while($row = $result->fetch_assoc()) {
    echo '<td style="border: 1px skyblue solid">'. $row["Name"]. "</td>".
          ...
          '<td style="border: 1px skyblue solid">'. $row["Join_Date"]. "</td>".
